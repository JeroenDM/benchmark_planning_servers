#ifndef _DESCARTES_SERVER_INTERPOLATION_H_
#define _DESCARTES_SERVER_INTERPOLATION_H_

#include <ros/ros.h>
#include <eigen3/Eigen/Geometry>

/* \Brief Linear interpolation between two Isometry3d poses.

    Using quaternion slerp to interpolate orientation
 */
std::vector<Eigen::Isometry3d> interpolate(Eigen::Isometry3d& start, Eigen::Isometry3d& goal, double max_pos,
                                           double max_rot)
{
